...
#Personal Laptop
"""
filename = "C:\\Users\\jayha\\Documents\\Gambling\\Automated\\Soccer\\Bundesliga Tracker.xlsx"
newLocation = "C:\\Users\\jayha\\Documents\\Gambling\\Automated\\Soccer\\Historical\\Bundesliga Tracker.xlsx"
newName = "Bundesliga " + filedate + ".xlsx"
#shutil.copyfile(filename, newLocation)
#os.rename("C:\\Users\\jhansen3\\OneDrive - KPMG\\Documents\\Python\\Gambling\\Soccer\\Historical\\Bundesliga Tracker.xlsx", "C:\\Users\\jhansen3\\OneDrive - KPMG\\Documents\\Python\\Gambling\\Soccer\\Historical\\" + newName)
"""
#Work Laptop
filename = "C:\\Users\\jhansen3\\OneDrive - KPMG\\Documents\\Python\\Gambling\\Soccer\\Bundesliga Tracker.xlsx"
newLocation = "C:\\Users\\jhansen3\\OneDrive - KPMG\\Documents\\Python\\Gambling\\Soccer\\Historical\\Bundesliga Tracker.xlsx"
newName = "Bundesliga " + filedate + ".xlsx"
shutil.copyfile(filename, newLocation)
os.rename("C:\\Users\\jhansen3\\OneDrive - KPMG\\Documents\\Python\\Gambling\\Soccer\\Historical\\Bundesliga Tracker.xlsx", "C:\\Users\\jhansen3\\OneDrive - KPMG\\Documents\\Python\\Gambling\\Soccer\\Historical\\" + newName)
...
#Finds the last row that has the score
...
webpage_response = requests.get('https://www.theguardian.com/football/bundesligafootball/results')
...
#Accounts for the differences in names in the sportsbet vs guardian
for a in range(0, 2*difference):
    if messy_teams_scores[a].get_text() == "VfL Bochum":
        teams_scores.append("Bochum")
    elif messy_teams_scores[a].get_text() == "Cologne":
        teams_scores.append("FC Koln")
    elif messy_teams_scores[a].get_text() == "Schalke":
        teams_scores.append("Schalke 04")
    elif messy_teams_scores[a].get_text() == "M'gladbach":
        teams_scores.append("Mgladbach")
    elif messy_teams_scores[a].get_text() == "Bayern":
        teams_scores.append("Bayern Munich")          
    else:    
...
print(len(scores))
print(len(teams_scores))


#Pastes the scores of the games
...
if difference == 0:
    ...
    #Stores team name and win-draw-win in excel
    for i in range(0, 9):
    ...
    #For each of the bet types it finds the odds
    more_odds = []
