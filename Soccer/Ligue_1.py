...
#Personal Laptop
"""
filename = "C:\\Users\\jayha\\Documents\\Gambling\\Automated\\Soccer\\Ligue 1 Tracker.xlsx"
newLocation = "C:\\Users\\jayha\\Documents\\Gambling\\Automated\\Soccer\\Historical\\Ligue 1 Tracker.xlsx"
newName = "Ligue 1 " + filedate + ".xlsx"
#shutil.copyfile(filename, newLocation)
#os.rename("C:\\Users\\jhansen3\\OneDrive - KPMG\\Documents\\Python\\Gambling\\Soccer\\Historical\\Ligue 1 Tracker.xlsx", "C:\\Users\\jhansen3\\OneDrive - KPMG\\Documents\\Python\\Gambling\\Soccer\\Historical\\" + newName)
"""
#Work Laptop
filename = "C:\\Users\\jhansen3\\OneDrive - KPMG\\Documents\\Python\\Gambling\\Soccer\\Ligue 1 Tracker.xlsx"
newLocation = "C:\\Users\\jhansen3\\OneDrive - KPMG\\Documents\\Python\\Gambling\\Soccer\\Historical\\Ligue 1 Tracker.xlsx"
newName = "Ligue 1 " + filedate + ".xlsx"
shutil.copyfile(filename, newLocation)
os.rename("C:\\Users\\jhansen3\\OneDrive - KPMG\\Documents\\Python\\Gambling\\Soccer\\Historical\\Ligue 1 Tracker.xlsx", "C:\\Users\\jhansen3\\OneDrive - KPMG\\Documents\\Python\\Gambling\\Soccer\\Historical\\" + newName)
...
webpage_response = requests.get('https://www.theguardian.com/football/ligue1football/results')
...
for a in range(0, 2*difference):
    if messy_teams_scores[a].get_text() == "PSG":
        teams_scores.append("Paris St-G")
    elif messy_teams_scores[a].get_text() == "Troyes":
        teams_scores.append("ESTAC Troyes")
    elif messy_teams_scores[a].get_text() == "Clermont Foot":
        teams_scores.append("Clermont")
    else:    
...
if difference == 0:
    ...
    webpage_response = requests.get('https://www.sportsbet.com.au/betting/soccer/france/french-ligue-1')
    webpage = webpage_response.content
    soup = BeautifulSoup(webpage, "html.parser")
    ...
    driver.get('https://www.sportsbet.com.au/betting/soccer/france/french-ligue-1')
...
workbook.save("Ligue 1 Tracker.xlsx")
