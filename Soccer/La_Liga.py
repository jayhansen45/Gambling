...
#Personal Laptop
"""
filename = "C:\\Users\\jayha\\Documents\\Gambling\\Automated\\Soccer\\La Liga Tracker.xlsx"
newLocation = "C:\\Users\\jayha\\Documents\\Gambling\\Automated\\Soccer\\Historical\\La Liga Tracker.xlsx"
newName = "La Liga " + filedate + ".xlsx"
#shutil.copyfile(filename, newLocation)
#os.rename("C:\\Users\\jhansen3\\OneDrive - KPMG\\Documents\\Python\\Gambling\\Soccer\\Historical\\La Liga Tracker.xlsx", "C:\\Users\\jhansen3\\OneDrive - KPMG\\Documents\\Python\\Gambling\\Soccer\\Historical\\" + newName)
"""
#Work Laptop
filename = "C:\\Users\\jhansen3\\OneDrive - KPMG\\Documents\\Python\\Gambling\\Soccer\\La Liga Tracker.xlsx"
newLocation = "C:\\Users\\jhansen3\\OneDrive - KPMG\\Documents\\Python\\Gambling\\Soccer\\Historical\\La Liga Tracker.xlsx"
newName = "La Liga " + filedate + ".xlsx"
shutil.copyfile(filename, newLocation)
os.rename("C:\\Users\\jhansen3\\OneDrive - KPMG\\Documents\\Python\\Gambling\\Soccer\\Historical\\La Liga Tracker.xlsx", "C:\\Users\\jhansen3\\OneDrive - KPMG\\Documents\\Python\\Gambling\\Soccer\\Historical\\" + newName)
...
webpage_response = requests.get('https://www.theguardian.com/football/laligafootball/results')
...
for a in range(0, 2*difference):
    if messy_teams_scores[a].get_text() == "A Bilbao":
        teams_scores.append("Athletic Bilbao")
    elif messy_teams_scores[a].get_text() == "Atlético":
        teams_scores.append("Atletico Madrid")
    elif messy_teams_scores[a].get_text() == "Real Betis":
        teams_scores.append("Betis")
    else:    
...
if difference == 0:
    ...
    webpage_response = requests.get('https://www.sportsbet.com.au/betting/soccer/spain/spanish-la-liga')
    webpage = webpage_response.content
    soup = BeautifulSoup(webpage, "html.parser")
    ...
    driver.get('https://www.sportsbet.com.au/betting/soccer/spain/spanish-la-liga')
...
workbook.save("La Liga Tracker.xlsx")
