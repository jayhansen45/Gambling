...
#Personal Laptop
"""
filename = "C:\\Users\\jayha\\Documents\\Gambling\\Automated\\Soccer\\EPL Tracker.xlsx"
newLocation = "C:\\Users\\jayha\\Documents\\Gambling\\Automated\\Soccer\\Historical\\EPL Tracker.xlsx"
newName = "EPL " + filedate + ".xlsx"
#shutil.copyfile(filename, newLocation)
#os.rename("C:\\Users\\jhansen3\\OneDrive - KPMG\\Documents\\Python\\Gambling\\Soccer\\Historical\\EPL Tracker.xlsx", "C:\\Users\\jhansen3\\OneDrive - KPMG\\Documents\\Python\\Gambling\\Soccer\\Historical\\" + newName)
"""
#Work Laptop
filename = "C:\\Users\\jhansen3\\OneDrive - KPMG\\Documents\\Python\\Gambling\\Soccer\\EPL Tracker.xlsx"
newLocation = "C:\\Users\\jhansen3\\OneDrive - KPMG\\Documents\\Python\\Gambling\\Soccer\\Historical\\EPL Tracker.xlsx"
newName = "EPL " + filedate + ".xlsx"
shutil.copyfile(filename, newLocation)
os.rename("C:\\Users\\jhansen3\\OneDrive - KPMG\\Documents\\Python\\Gambling\\Soccer\\Historical\\EPL Tracker.xlsx", "C:\\Users\\jhansen3\\OneDrive - KPMG\\Documents\\Python\\Gambling\\Soccer\\Historical\\" + newName)
...
webpage_response = requests.get('https://www.theguardian.com/football/premierleague/results')
...
for a in range(0, 2*difference):
    if messy_teams_scores[a].get_text() == "C Palace":
        teams_scores.append("Crystal Palace")
    elif messy_teams_scores[a].get_text() == "AFC Bournemouth":
        teams_scores.append("Bournemouth")
...
if difference == 0:
    ...
    webpage_response = requests.get('https://www.sportsbet.com.au/betting/soccer/united-kingdom/english-premier-league')
    webpage = webpage_response.content
    soup = BeautifulSoup(webpage, "html.parser")
