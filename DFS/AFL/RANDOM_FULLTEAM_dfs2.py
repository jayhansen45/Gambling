...
data = xl.load_workbook("C:\\Users\\jhansen3\\OneDrive - KPMG\\Documents\\Python\\Gambling\\DFS\\AFL\\Data2.xlsx")
fw = data.worksheets[1]
mid = data.worksheets[2]
de = data.worksheets[3]
rk = data.worksheets[4]
...
arrays = [[fw_array, mid_array, de_array, rk_array], [fw_array_salary, mid_array_salary, de_array_salary, rk_array_salary]]
...
actual_array = [[arrays[0][0], arrays[0][0], arrays[0][1], arrays[0][1], arrays[0][1], arrays[0][1], arrays[0][2], arrays[0][2], arrays[0][3]], [arrays[1][0], arrays[1][0], arrays[1][1], arrays[1][1], arrays[1][1], arrays[1][1], arrays[1][2], arrays[1][2], arrays[1][3]]]
...
for i in range(0, 100000000):
    ...
    combo = [arrays[0][0][0], arrays[0][0][1], arrays[0][1][0], arrays[0][1][1], arrays[0][1][2], arrays[0][1][3], arrays[0][2][0], arrays[0][2][1], arrays[0][3][0]]
