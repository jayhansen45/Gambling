...
data = xl.load_workbook("C:\\Users\\jhansen3\\OneDrive - KPMG\\Documents\\Python\\Gambling\\DFS\\NBA\\Data2.xlsx")
...
for i in range(0, 100000000):
    ...
    combo = [arrays[0][0][0], arrays[0][0][1], arrays[0][1][0], arrays[0][1][1], arrays[0][2][0], arrays[0][2][1], arrays[0][3][0], arrays[0][3][1], arrays[0][4][0]]
