...
data = xl.load_workbook("C:\\Users\\jhansen3\\OneDrive - KPMG\\Documents\\Python\\Gambling\\DFS\\NRL Data - Copy (2).xlsx")
...
high_data = xl.load_workbook("C:\\Users\\jhansen3\\OneDrive - KPMG\\Documents\\Python\\Gambling\\DFS\\HIGH_NRL Data - Copy.xlsx")
...
high_sheets = [high_qb, high_rb, high_wr, high_te]
sheets = [qb, rb, wr, te]

arrays = [[qb_array, rb_array, wr_array, te_array], [qb_array_salary, rb_array_salary, wr_array_salary, te_array_salary]]
high_array = [high_qb_array, high_rb_array, high_wr_array, high_te_array]
...
actual_array = [[arrays[0][0], arrays[0][0], arrays[0][1], arrays[0][2], arrays[0][2], arrays[0][2], arrays[0][3]], [arrays[1][0], arrays[1][0], arrays[1][1], arrays[1][2], arrays[1][2], arrays[1][2], arrays[1][3]]]
