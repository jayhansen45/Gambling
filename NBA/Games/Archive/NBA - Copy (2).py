...
#Work Laptop
filename = "C:\\Users\\jhansen3\\OneDrive - KPMG\\Documents\\Python\\Gambling\\NBA\\Games\\NBA Tracker.xlsx"
newLocation = "C:\\Users\\jhansen3\\OneDrive - KPMG\\Documents\\Python\\Gambling\\NBA\\Games\\Historical\\NBA Tracker.xlsx"
newName = "NBA " + filedate + ".xlsx"
shutil.copyfile(filename, newLocation)
os.rename("C:\\Users\\jhansen3\\OneDrive - KPMG\\Documents\\Python\\Gambling\\NBA\\Games\\Historical\\NBA Tracker.xlsx", "C:\\Users\\jhansen3\\OneDrive - KPMG\\Documents\\Python\\Gambling\\NBA\\Games\\Historical\\" + newName)
...
"""webpage_response = requests.get('https://sports.yahoo.com/nba/scoreboard/?confId=&dateRange=' + day_site + '&schedState=2')
...
"""
driver.get('https://sports.yahoo.com/nba/scoreboard/?confId=&dateRange=' + day_site + '&schedState=2')
...
"""
webpage_response = requests.get('https://sports.yahoo.com/nba/scoreboard/?confId=&dateRange=' + tomorrow_site + '&schedState=2')
webpage = webpage_response.content
soup = BeautifulSoup(webpage, "html.parser")
...
"""
driver.get('https://sports.yahoo.com/nba/scoreboard/?confId=&dateRange=' + tomorrow_site + '&schedState=2')
...
if games != 0:
    ...
    """webpage_response = requests.get('https://www.sportsbet.com.au/betting/basketball-us/nba')
    webpage = webpage_response.content
    soup = BeautifulSoup(webpage, "html.parser")
    ...
    bets = ["Total Points", "Match Betting", "Big Win Little Win", "Winning Margin (Four Bands)", "Winning Margin (10 Pt)", "Winning Margin (Bands)", "Handicap Betting", "Double Result", "Tri-Bet", "Tri-Bet 2", "Tri-Bet 3", "Tri-Bet 4", "Tri-Bet 5", "Wire To Wire"]
    messy_more_odds = []
    odds =[]
    count = 7
    row = 2
    ...
    for i in range(0, len(bets)):
        ...
        if bets[i] == "Winning Margin (Bands)":
            time.sleep(10)
            action = ActionChains(driver)
...
workbook.save("NBA Tracker.xlsx")
driver.close()
driver.quit()
