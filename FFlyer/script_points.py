...
airports = [62, 64, 107, 186, 241, 223, 224, 226, 255, 267, 277, 280, 389, 390, 131, 231, 268]
...
for q in range(20+start_date, 200):
    ...
    time.sleep(2)
    #For loop goes here
    for c in range(start, len(airports)):
        #No flights catch
        print("Next Country")
        check = 0
        try:
        ...
        search = '//*[@id="react-autowhatever-arriving-airport0-auto-suggest--item-'+ str(airports[c]) + '"]'
